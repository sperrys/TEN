...
import sellConfirmation from './Components/Sell/confirmationPage';
...
export const SELL_CONFIRMATION = "confirmation"
...
ReactDOM.render(
	<div className="BodyWrapper">
	    ...
	    <Router>
	      <Route exact path={"/" + SELL_CONFIRMATION} component={confirmationPage}/>
	    </Router>
		<Router>
